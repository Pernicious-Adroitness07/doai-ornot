...
csv1_df = pd.read_csv(r'C:\Users\soumy\OneDrive\Documents\Work Stuff\DFA\Py Codes\ELECT Loan Data (1).csv')
csv2_df = pd.read_csv(r'C:\Users\soumy\OneDrive\Documents\Work Stuff\DFA\Py Codes\ELECT_Loans_Database_Table.csv')
